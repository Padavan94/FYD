...
<?php if ($column_left && $column_right) { ?>
  ...
  <div class="grid_holder">
    ...
    --><div class="item contrast_font product-layout">
       <div class="image">
        <?php if ($product['latest'] && $cosyone_percentage_sale_badge == 'enabled') { ?>
      ...
      <div class="price">
        ...
        <?php } else { ?>
        <span class="price-old"><?php echo $product['price']; ?></span> <span class="price-new"><?php echo $product['latest']; ?></span>
        <?php } ?>
        <?php if ($product['tax']) { ?>
        <br />
    ...
    <a class="plain_link compare" onclick="compare.add('<?php echo $product['product_id']; ?>');" ><?php echo $button_compare; ?></a>
        ...
        <?php if (($product['latest']) && ($product['latest_date_end'] > 0) && ($cosyone_product_countdown)) { ?>
		...
		until: <?php echo $product['latest_date_end']; ?>, 
