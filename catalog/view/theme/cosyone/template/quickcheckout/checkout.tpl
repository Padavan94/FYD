...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> checkout-quiq"><?php echo $content_top; ?>
  ...
  <div class="quickcheckoutmid collapse" id="login-box">
    <div id="checkout">
	  ...
	  <div class="checkout-column">
        ...
        <div id="shipping-address" style="display: none;"><br />
		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['redirect']) {
					...
					$('html, body').animate({ scrollTop: $("#shipping-method").offset().top}, 'slow');
